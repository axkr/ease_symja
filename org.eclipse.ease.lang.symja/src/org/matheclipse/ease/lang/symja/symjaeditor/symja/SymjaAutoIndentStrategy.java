 ...
 */
public class SymjaAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {

	public SymjaAutoIndentStrategy() {
	}
	 ...
	 */
	 protected void smartIndentAfterNewLine(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(SymjaEditorMessages.getString("AutoIndent.error.bad_location_1")); //$NON-NLS-1$
		}
	}
	 ...
	 */
	 protected void smartInsertAfterBracket(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(SymjaEditorMessages.getString("AutoIndent.error.bad_location_2")); //$NON-NLS-1$
		}
	}
}
