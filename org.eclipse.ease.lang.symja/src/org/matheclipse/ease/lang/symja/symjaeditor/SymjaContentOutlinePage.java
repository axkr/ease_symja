 ...
 */
public class SymjaContentOutlinePage extends ContentOutlinePage {
		...
		protected void parse(IDocument document) {
			...
			for (int line= 0; line < lines; line += increment) {
				...
				try {
					...
					fContent.add(new Segment(MessageFormat.format(SymjaEditorMessages.getString("OutlinePage.segment.title_pattern"), new Object[] { Integer.valueOf(offset) }), p)); //$NON-NLS-1$
	 ...
	 */
	public SymjaContentOutlinePage(IDocumentProvider provider, ITextEditor editor) {
		super();
