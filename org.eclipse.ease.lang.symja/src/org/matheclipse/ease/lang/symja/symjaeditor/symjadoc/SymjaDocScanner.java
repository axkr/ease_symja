 ...
 *******************************************************************************/
package org.matheclipse.ease.lang.symja.symjaeditor.symjadoc;
 ...
 */
public class SymjaDocScanner extends RuleBasedScanner {
	 ...
	 */
	 public SymjaDocScanner(SymjaColorProvider provider) {
		super();

		setDefaultReturnToken(new Token(new TextAttribute(provider.getColor(SymjaColorProvider.JAVADOC_DEFAULT))));

		IToken keyword= new Token(new TextAttribute(provider.getColor(SymjaColorProvider.JAVADOC_KEYWORD)));
		IToken tag= new Token(new TextAttribute(provider.getColor(SymjaColorProvider.JAVADOC_TAG)));
		IToken link= new Token(new TextAttribute(provider.getColor(SymjaColorProvider.JAVADOC_LINK)));
		...
		list.add(new WhitespaceRule(new SymjaWhitespaceDetector()));
