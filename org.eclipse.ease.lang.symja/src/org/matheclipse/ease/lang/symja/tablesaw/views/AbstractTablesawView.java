package org.matheclipse.ease.lang.symja.tablesaw.views;
...
import org.matheclipse.ease.lang.symja.tablesaw.TableProvider;
import org.matheclipse.ease.lang.symja.tablesaw.TableProviderRegistry;
import org.matheclipse.ease.lang.symja.tablesaw.util.MultiCheckSelectionCombo;
import org.matheclipse.ease.lang.symja.tablesaw.util.MultiCheckSelectionShell;
import org.matheclipse.ease.lang.symja.tablesaw.util.Util;
...
public abstract class AbstractTablesawView extends ViewPart implements TableProvider.Listener {
	...
	public void createPartControl(final Composite parent) {
		...
		if (this instanceof TableProvider) {
			SymjaPlugin.getDefault().getTableProviderRegistry().registerTableProvider(getPartName(), (TableProvider) this);
		}
    ...
    private void registerTableProvicer(AbstractTablesawView tablesawView) {
        if (tablesawView instanceof TableProvider || tablesawView == null) {
        	SymjaPlugin.getDefault().getTableProviderRegistry().registerTableProvider(getPartName(), (TableProvider) tablesawView);
		}
    }
...
//        addTableRegistrySelectorContribution();
	...
	protected void addTableRegistrySelectorContribution() {
        ...
        tablesMenu.addMenuListener(sourcesMenu -> {
            TableProviderRegistry tableProviderRegistry = SymjaPlugin.getDefault().getTableProviderRegistry();
...
//		createTableRegistrySelector("Source: ", configParent, null);
	...
	protected void createTableRegistrySelector(final String label, final Composite parent, final TableProvider except) {
		...
		SymjaPlugin.getDefault().getTableProviderRegistry().addTableRegistryChangedListener(registryListener);
		viewer.setInput(SymjaPlugin.getDefault().getTableProviderRegistry());
	}
	...
	protected class TableRegistryMenuCreator extends SelectionAdapter implements IMenuCreator, SelectionListener {
		...
		public void widgetSelected(final SelectionEvent e) {
			...
			final TableProviderRegistry tableProviderRegistry = SymjaPlugin.getDefault().getTableProviderRegistry();
		...
		public Menu getMenu(final Menu parent) {
			System.out.println(SymjaPlugin.getDefault().getTableProviderRegistry().getTableProviderKeys());
			if (menu == null) {
		...
		public void addMenuItems(final Menu menu) {
			for (final String key : SymjaPlugin.getDefault().getTableProviderRegistry().getTableProviderKeys()) {
	...
	protected void tableProviderChanged(final String key) {
	    ...
	    tableProviderChanged(SymjaPlugin.getDefault().getTableProviderRegistry().getTableProvider(key));
	}
