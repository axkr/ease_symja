...
import org.eclipse.ease.lang.symja.symjaeditor.java.JavaAutoIndentStrategy;
import org.eclipse.ease.lang.symja.symjaeditor.java.JavaCompletionProcessor;
import org.eclipse.ease.lang.symja.symjaeditor.java.JavaDoubleClickSelector;
import org.eclipse.ease.lang.symja.symjaeditor.javadoc.SymjaDocCompletionProcessor;
...
public class JavaSourceViewerConfiguration extends SourceViewerConfiguration {
	...
	public IAutoEditStrategy[] getAutoEditStrategies(ISourceViewer sourceViewer, String contentType) {
		IAutoEditStrategy strategy = (IDocument.DEFAULT_CONTENT_TYPE.equals(contentType) ? new JavaAutoIndentStrategy()
	...
	public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
		return new String[] { IDocument.DEFAULT_CONTENT_TYPE, JavaPartitionScanner.JAVA_DOC,
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new SymjaDocCompletionProcessor(), JavaPartitionScanner.JAVA_DOC);
