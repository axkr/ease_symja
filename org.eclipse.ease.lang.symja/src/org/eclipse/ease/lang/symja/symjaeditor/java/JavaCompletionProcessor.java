 ...
 *******************************************************************************/
package org.eclipse.ease.lang.symja.symjaeditor.java;
...
//							JavaEditorMessages.getString("CompletionProcessor.Proposal.ContextInfo.pattern"), //$NON-NLS-1$
//							new Object[] { fgProposals[i] }));
//			result[i] = new CompletionProposal(fgProposals[i], documentOffset, 0, fgProposals[i].length(), null,
//					fgProposals[i], info,
//					MessageFormat.format(JavaEditorMessages.getString("CompletionProcessor.Proposal.hoverinfo.pattern"), //$NON-NLS-1$
//							new Object[] { fgProposals[i] }));
//		}
//		return result;
	}
	...
	public IContextInformation[] computeContextInformation(ITextViewer viewer, int documentOffset) {
		...
		for (int i = 0; i < result.length; i++)
			result[i] = new ContextInformation(
					MessageFormat.format(
							JavaEditorMessages.getString("CompletionProcessor.ContextInfo.display.pattern"), //$NON-NLS-1$
							new Object[] { Integer.valueOf(i), Integer.valueOf(documentOffset) }),
					MessageFormat.format(JavaEditorMessages.getString("CompletionProcessor.ContextInfo.value.pattern"), //$NON-NLS-1$
