 ...
 */
public class SymjaPartitionScanner extends RuleBasedPartitionScanner {
...
//		rules.add(new WordPredicateRule(comment));
		...
		rules.add(new MultiLineRule("(*", "*)", javaDoc, (char) 0, false)); //$NON-NLS-1$ //$NON-NLS-2$
